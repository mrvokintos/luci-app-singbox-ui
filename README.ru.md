...
- Автоматический выбор IPK/APK и архитектуры для Original, Extended или Clean ядра
...
3. При установке sing-box выберите ядро: `Original` (по умолчанию), `Extended` или очищенный `Clean`
